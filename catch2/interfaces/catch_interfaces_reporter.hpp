...
// BEGIN Amalgamated content from catch_interfaces_reporter.cpp (@wolfram77)
#ifndef CATCH_INTERFACES_REPORTER_CPP_INCLUDED
#define CATCH_INTERFACES_REPORTER_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_interfaces_reporter.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_INTERFACES_REPORTER_CPP_INCLUDED
// END Amalgamated content from catch_interfaces_reporter.cpp (@wolfram77)
