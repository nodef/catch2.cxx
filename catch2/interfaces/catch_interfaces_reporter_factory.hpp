...
// BEGIN Amalgamated content from catch_interfaces_reporter_factory.cpp (@wolfram77)
#ifndef CATCH_INTERFACES_REPORTER_FACTORY_CPP_INCLUDED
#define CATCH_INTERFACES_REPORTER_FACTORY_CPP_INCLUDED
...
// #include "catch_interfaces_reporter_factory.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_INTERFACES_REPORTER_FACTORY_CPP_INCLUDED
// END Amalgamated content from catch_interfaces_reporter_factory.cpp (@wolfram77)
