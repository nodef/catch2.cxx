...
// BEGIN Amalgamated content from catch_commandline.cpp (@wolfram77)
#ifndef CATCH_COMMANDLINE_CPP_INCLUDED
#define CATCH_COMMANDLINE_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_commandline.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_COMMANDLINE_CPP_INCLUDED
// END Amalgamated content from catch_commandline.cpp (@wolfram77)
