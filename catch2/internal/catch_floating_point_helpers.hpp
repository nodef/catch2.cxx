...
// BEGIN Amalgamated content from catch_floating_point_helpers.cpp (@wolfram77)
#ifndef CATCH_FLOATING_POINT_HELPERS_CPP_INCLUDED
#define CATCH_FLOATING_POINT_HELPERS_CPP_INCLUDED
...
// #include "catch_floating_point_helpers.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_FLOATING_POINT_HELPERS_CPP_INCLUDED
// END Amalgamated content from catch_floating_point_helpers.cpp (@wolfram77)
