...
// BEGIN Amalgamated content from catch_string_manip.cpp (@wolfram77)
#ifndef CATCH_STRING_MANIP_CPP_INCLUDED
#define CATCH_STRING_MANIP_CPP_INCLUDED
...
// #include "catch_string_manip.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
#include "catch_stringref.hpp"  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_STRING_MANIP_CPP_INCLUDED
// END Amalgamated content from catch_string_manip.cpp (@wolfram77)
