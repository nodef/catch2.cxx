...
// BEGIN Amalgamated content from catch_console_colour.cpp (@wolfram77)
#ifndef CATCH_CONSOLE_COLOUR_CPP_INCLUDED
#define CATCH_CONSOLE_COLOUR_CPP_INCLUDED
...
// #include "catch_console_colour.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_CONSOLE_COLOUR_CPP_INCLUDED
// END Amalgamated content from catch_console_colour.cpp (@wolfram77)
