...
// BEGIN Amalgamated content from catch_parse_numbers.cpp (@wolfram77)
#ifndef CATCH_PARSE_NUMBERS_CPP_INCLUDED
#define CATCH_PARSE_NUMBERS_CPP_INCLUDED
...
// #include "catch_parse_numbers.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_PARSE_NUMBERS_CPP_INCLUDED
// END Amalgamated content from catch_parse_numbers.cpp (@wolfram77)
