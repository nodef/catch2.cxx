...
// BEGIN Amalgamated content from catch_test_spec_parser.cpp (@wolfram77)
#ifndef CATCH_TEST_SPEC_PARSER_CPP_INCLUDED
#define CATCH_TEST_SPEC_PARSER_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_test_spec_parser.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_TEST_SPEC_PARSER_CPP_INCLUDED
// END Amalgamated content from catch_test_spec_parser.cpp (@wolfram77)
