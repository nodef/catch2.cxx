...
// BEGIN Amalgamated content from catch_reusable_string_stream.cpp (@wolfram77)
#ifndef CATCH_REUSABLE_STRING_STREAM_CPP_INCLUDED
#define CATCH_REUSABLE_STRING_STREAM_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_reusable_string_stream.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_REUSABLE_STRING_STREAM_CPP_INCLUDED
// END Amalgamated content from catch_reusable_string_stream.cpp (@wolfram77)
