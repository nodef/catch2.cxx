...
// BEGIN Amalgamated content from catch_decomposer.cpp (@wolfram77)
#ifndef CATCH_DECOMPOSER_CPP_INCLUDED
#define CATCH_DECOMPOSER_CPP_INCLUDED
...
// #include "catch_decomposer.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_DECOMPOSER_CPP_INCLUDED
// END Amalgamated content from catch_decomposer.cpp (@wolfram77)
