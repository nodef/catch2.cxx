...
// BEGIN Amalgamated content from catch_test_case_tracker.cpp (@wolfram77)
#ifndef CATCH_TEST_CASE_TRACKER_CPP_INCLUDED
#define CATCH_TEST_CASE_TRACKER_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_test_case_tracker.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_TEST_CASE_TRACKER_CPP_INCLUDED
// END Amalgamated content from catch_test_case_tracker.cpp (@wolfram77)
