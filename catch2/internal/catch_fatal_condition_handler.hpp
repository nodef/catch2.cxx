...
// BEGIN Amalgamated content from catch_fatal_condition_handler.cpp (@wolfram77)
#ifndef CATCH_FATAL_CONDITION_HANDLER_CPP_INCLUDED
#define CATCH_FATAL_CONDITION_HANDLER_CPP_INCLUDED
...
// #include "catch_fatal_condition_handler.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_FATAL_CONDITION_HANDLER_CPP_INCLUDED
// END Amalgamated content from catch_fatal_condition_handler.cpp (@wolfram77)
