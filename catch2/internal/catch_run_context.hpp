...
// BEGIN Amalgamated content from catch_run_context.cpp (@wolfram77)
#ifndef CATCH_RUN_CONTEXT_CPP_INCLUDED
#define CATCH_RUN_CONTEXT_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_run_context.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_RUN_CONTEXT_CPP_INCLUDED
// END Amalgamated content from catch_run_context.cpp (@wolfram77)
