...
// BEGIN Amalgamated content from catch_matchers_templated.cpp (@wolfram77)
#ifndef CATCH_MATCHERS_TEMPLATED_CPP_INCLUDED
#define CATCH_MATCHERS_TEMPLATED_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_matchers_templated.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_MATCHERS_TEMPLATED_CPP_INCLUDED
// END Amalgamated content from catch_matchers_templated.cpp (@wolfram77)
