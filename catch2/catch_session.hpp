...
// BEGIN Amalgamated content from catch_session.cpp (@wolfram77)
#ifndef CATCH_SESSION_CPP_INCLUDED
#define CATCH_SESSION_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_session.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
