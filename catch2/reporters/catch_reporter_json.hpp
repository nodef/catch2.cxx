...
// BEGIN Amalgamated content from catch_reporter_json.cpp (@wolfram77)
#ifndef CATCH_REPORTER_JSON_CPP_INCLUDED
#define CATCH_REPORTER_JSON_CPP_INCLUDED
...
// #include "catch_reporter_json.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_REPORTER_JSON_CPP_INCLUDED
// END Amalgamated content from catch_reporter_json.cpp (@wolfram77)
