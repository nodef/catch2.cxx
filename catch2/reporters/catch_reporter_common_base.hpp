...
// BEGIN Amalgamated content from catch_reporter_common_base.cpp (@wolfram77)
#ifndef CATCH_REPORTER_COMMON_BASE_CPP_INCLUDED
#define CATCH_REPORTER_COMMON_BASE_CPP_INCLUDED
...
// #include "catch_reporter_common_base.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_REPORTER_COMMON_BASE_CPP_INCLUDED
// END Amalgamated content from catch_reporter_common_base.cpp (@wolfram77)
