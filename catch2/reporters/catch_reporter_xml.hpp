...
// BEGIN Amalgamated content from catch_reporter_xml.cpp (@wolfram77)
#ifndef CATCH_REPORTER_XML_CPP_INCLUDED
#define CATCH_REPORTER_XML_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_reporter_xml.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_REPORTER_XML_CPP_INCLUDED
// END Amalgamated content from catch_reporter_xml.cpp (@wolfram77)
