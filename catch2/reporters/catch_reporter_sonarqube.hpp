...
// BEGIN Amalgamated content from catch_reporter_sonarqube.cpp (@wolfram77)
#ifndef CATCH_REPORTER_SONARQUBE_CPP_INCLUDED
#define CATCH_REPORTER_SONARQUBE_CPP_INCLUDED
...
// SPDX-License-Identifier: BSL-1.0
// #include "catch_reporter_sonarqube.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_REPORTER_SONARQUBE_CPP_INCLUDED
// END Amalgamated content from catch_reporter_sonarqube.cpp (@wolfram77)
