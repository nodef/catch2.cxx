...
// BEGIN Amalgamated content from catch_reporter_helpers.cpp (@wolfram77)
#ifndef CATCH_REPORTER_HELPERS_CPP_INCLUDED
#define CATCH_REPORTER_HELPERS_CPP_INCLUDED
...
// #include "catch_reporter_helpers.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
#include "../interfaces/catch_interfaces_config.hpp"  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_REPORTER_HELPERS_CPP_INCLUDED
// END Amalgamated content from catch_reporter_helpers.cpp (@wolfram77)
