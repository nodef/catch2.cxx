...
// BEGIN Amalgamated content from catch_stats.cpp (@wolfram77)
#ifndef CATCH_STATS_CPP_INCLUDED
#define CATCH_STATS_CPP_INCLUDED
...
// #include "catch_stats.hpp" // Disable self-include (@wolfram77)  // Adjust to relative path (@wolfram77)
...
#endif // CATCH_STATS_CPP_INCLUDED
// END Amalgamated content from catch_stats.cpp (@wolfram77)
